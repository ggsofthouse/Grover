...
def dispatch_to_bitcrack(prefix_bin, total_puzzle_bits):
    ...
    address_alvo = "14oFNXucftsHiUMY8uctg6N487riuyXs4h" # Endereço do Puzzle 21
    ...
    print(f"Pista Localizada: A Chave Privada do Puzzle 21 está aproximadamente na faixa de {percentage:.4f}% do Range Total.")
...
def main():
    print("\n==========================================================")
    print("   PUZZLE 21: RADAR QUÂNTICO + MPS (MATRIX PRODUCT STATE)")
    print("==========================================================")
    ...
    # Para o Puzzle 21, o range é 2^20 a 2^21 - 1.
    # Como a GPU processa 4 bits, a CPU varre o prefixo de 17 bits.
    # O prefixo deve ter o bit mais significativo igual a 1.
    # Portanto, o loop da CPU vai de 2^(16) até (2^17)-1.
